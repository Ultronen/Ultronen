...
**Full-stack engineer moving into AI application development — LLM pipelines, multi-agent systems, and RAG.**

全栈工程师转 AI 应用开发方向，专注 LLM 应用、Multi-Agent 系统与 RAG 工程。
...
### [Session Archive](https://github.com/Ultronen/dsh-archived-chats)

A local-first session management tool: full-text search, read-only previews, version restore-as-copy, ZIP backup and recovery, a protected Recycle Bin, storage accounting, and retention policies. Includes cross-platform CI, 201 automated tests, and bilingual documentation.

[Plugin market](https://awesome-dsh-plugin.com/p/Ultronen/dsh-archived-chats/) · [npm](https://www.npmjs.com/package/dsh-archived-chats) · [Releases](https://github.com/Ultronen/dsh-archived-chats/releases)
...
For project questions and collaboration, start a Discussion or open a focused Issue in the relevant repository.
